  ...
  return (
    <>
      <StayCarePurposeNote
        ...
        purpose={{
          ko: "이메일, +94·+82 휴대전화 OTP 또는 운영에서 활성화한 Google·Facebook 계정으로 연락수단 소유를 확인합니다. 로그인 후 공식 초대명부와 계정을 연결해야 근로자 앱이 활성화됩니다.",
          en: "Verify ownership through email, +94/+82 phone OTP, or an enabled Google/Facebook account. After sign-in, the account must match the official invitation roster before the worker app is activated.",
          si: "Email, +94/+82 දුරකථන OTP හෝ සක්‍රිය Google/Facebook ගිණුමකින් සම්බන්ධතා හිමිකම තහවුරු කරයි. පසුව නිල ආරාධනා ලැයිස්තුවට ගිණුම සම්බන්ධ කළ යුතුය.",
          ta: "மின்னஞ்சல், +94/+82 தொலைபேசி OTP அல்லது இயக்கப்பட்ட Google/Facebook கணக்கின் மூலம் தொடர்பு உரிமையைச் சரிபார்க்கிறது. உள்நுழைந்த பிறகு அதிகாரப்பூர்வ அழைப்புப் பட்டியலுடன் கணக்கு பொருந்தினால்தான் தொழிலாளர் செயலி செயல்படும்.",
        }}
        boundary={{
        ...
        items={[
          { label: { ko: "1. 연락수단 인증", en: "1. Verify contact", si: "1. සම්බන්ධතාව තහවුරු කිරීම", ta: "1. தொடர்பைச் சரிபார்க்கவும்" }, description: { ko: "이메일·SMS OTP 또는 선택형 소셜 로그인", en: "Email/SMS OTP or optional social login", si: "Email/SMS OTP හෝ සමාජ පිවිසුම", ta: "மின்னஞ்சல்/SMS OTP அல்லது விருப்ப சமூக உள்நுழைவு" } },
