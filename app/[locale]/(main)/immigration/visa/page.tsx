...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `${t("pages.immigrationVisa.title")} | ${t("common.title")}`,
    description: t("pages.immigrationVisa.description"),
  }
}

export default async function VisaPage() {
  const t = await getTranslations("pages.immigrationVisa")
  ...
  const services = [
    ...
    {
      title: t("services.refusal.title"),
      description: t("services.refusal.description"),
  ...
  const faqs = [
    ...
    {
      question: t("faqs.author.question"),
      answer: t("faqs.author.answer"),
    },
  ]
