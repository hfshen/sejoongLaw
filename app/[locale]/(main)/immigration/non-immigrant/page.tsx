...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `${t("pages.nonImmigrant.title")} | ${t("common.title")}`,
    description: t("pages.nonImmigrant.description"),
  }
}

export default async function NonImmigrantPage() {
  const t = await getTranslations("pages.nonImmigrant")
  ...
  const process = [
    ...
    {
      step: 4,
      title: t("processSteps.interview.title"),
      description: t("processSteps.interview.description"),
    },
    {
      step: 5,
  ...
  const faqs = [
    ...
    {
      question: t("faqs.extension.question"),
      answer: t("faqs.extension.answer"),
    },
  ]
