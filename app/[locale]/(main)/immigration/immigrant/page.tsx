...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `${t("pages.immigrant.title")} | ${t("common.title")}`,
    description: t("pages.immigrant.description"),
  }
}

export default async function ImmigrantPage() {
  const t = await getTranslations("pages.immigrant")

  const services = [
    {
      title: t("services.permanent.title"),
    ...
    },
    {
      ...
      description: t("services.marriage.description"),
      icon: <Heart className="w-6 h-6" />,
    },
    {
  ...
  const process = [
    ...
    {
      step: 5,
      title: t("processSteps.settlement.title"),
      description: t("processSteps.settlement.description"),
    },
  ]

  const faqs = [
    {
      question: t("faqs.qualification.question"),
      answer: t("faqs.qualification.answer"),
    },
    {
      question: t("faqs.citizenship.question"),
      answer: t("faqs.citizenship.answer"),
    },
    {
