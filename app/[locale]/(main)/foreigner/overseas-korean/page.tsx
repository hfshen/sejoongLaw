...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `${t("pages.overseasKorean.title")} | ${t("common.title")}`,
    description: t("pages.overseasKorean.description"),
  }
}

export default async function OverseasKoreanPage() {
  const t = await getTranslations("pages.overseasKorean")
  ...
  const faqs = [
    ...
    {
      question: t("faqs.employment.question"),
      answer: t("faqs.employment.answer"),
    },
    {
      question: t("faqs.benefit.question"),
      answer: t("faqs.benefit.answer"),
    },
  ]
