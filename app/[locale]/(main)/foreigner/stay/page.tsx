...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `${t("pages.stay.title")} | ${t("common.title")}`,
    description: t("pages.stay.description"),
  }
}

export default async function StayPage() {
  const t = await getTranslations("pages.stay")

  const services = [
    {
      title: t("services.extension.title"),
      description: t("services.extension.description"),
      icon: <RefreshCw className="w-6 h-6" />,
    },
    {
      title: t("services.change.title"),
      description: t("services.change.description"),
      icon: <CheckCircle className="w-6 h-6" />,
    },
    {
      title: t("services.address.title"),
      description: t("services.address.description"),
    ...
    {
      title: t("services.illegal.title"),
      description: t("services.illegal.description"),
  ...
  const process = [
    ...
    {
      step: 2,
      title: t("processSteps.qualification.title"),
      description: t("processSteps.qualification.description"),
    },
    {
      step: 3,
  ...
  const faqs = [
    ...
    {
      question: t("faqs.change.question"),
      answer: t("faqs.change.answer"),
    },
    {
      question: t("faqs.overstay.question"),
      answer: t("faqs.overstay.answer"),
    },
  ]
