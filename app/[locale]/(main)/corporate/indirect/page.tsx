...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `${t("pages.indirect.title")} | ${t("common.title")}`,
    description: t("pages.indirect.description"),
  }
}

export default async function IndirectPage() {
  const t = await getTranslations("pages.indirect")
  ...
  const services = [
    ...
    {
      title: t("services.dissolution.title"),
      description: t("services.dissolution.description"),
  ...
  const process = [
    ...
    {
      step: 5,
      title: t("processSteps.distribution.title"),
      description: t("processSteps.distribution.description"),
    },
  ]

  const faqs = [
    {
      question: t("faqs.permit.question"),
      answer: t("faqs.permit.answer"),
    },
    {
      question: t("faqs.issues.question"),
      answer: t("faqs.issues.answer"),
    },
    {
      question: t("faqs.protection.question"),
      answer: t("faqs.protection.answer"),
    },
  ]
